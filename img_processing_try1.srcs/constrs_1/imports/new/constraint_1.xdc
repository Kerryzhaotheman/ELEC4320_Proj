...
set_property PACKAGE_PIN U18 [get_ports {median_trig}]
set_property IOSTANDARD LVCMOS33 [get_ports {median_trig}]

set_property PACKAGE_PIN T17 [get_ports {sobel_trig}]
set_property IOSTANDARD LVCMOS33 [get_ports {sobel_trig}]
